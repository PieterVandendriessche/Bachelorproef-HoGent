...
\Abstract{Toegankelijkheid bij mobiele apps laat een ontwikkelaar toe om zoveel mogelijk gebruikers te bereiken. Toegankelijkheid integreren in een applicatie zorgt voor een hogere kwaliteit en laat gebruikers met een beperking toe om toegang te hebben tot informatie, sociale interactie en economische betrokkenheid. Onwetendheid zorgt ervoor dat een groot aantal functionaliteiten aangeboden in zowel iOS als Android niet gebruikt worden voor apps toegankelijker te maken. In dit onderzoek wordt nagegaan in welke mate beide platformen verschillen inzake toegankelijkheid. Dit onderzoek zal enkele richtlijnen bepalen die de ontwikkelaar moet toepassen om zijn applicatie toegankelijk te maken voor zoveel mogelijk gebruikers. Aan de hand van deze richtlijnen zal er ook onderzocht worden of bepaalde populaire applicaties toegankelijk genoeg zijn.
Tevens wordt er gekeken of verbeteringen voor toegankelijkheid een positief effect heeft op het gebruikersgemak van apps. Er wordt verwacht van dit onderzoek dat er meer aandacht moet gespendeerd worden aan toegankelijkheid voor mobiele apps. Hopelijk kan dit onderzoek bijdragen aan toekomstige integratie van toegankelijkheid in mobiele apps.  }
...
\Keywords{Mobiele applicatieontwikkeling --- Toegankelijkheid } % Keywords
